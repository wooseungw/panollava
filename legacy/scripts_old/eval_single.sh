...
python scripts/eval.py \
    --checkpoint runs/anyres_e2p_mlp_singlehead/finetune/anyres-e2p_bimamba/siglip2_bimamba_anyres-e2p_train_epoch00_loss2.3300.ckpt \
    --config configs/anyres_e2p_singlehead.yaml
