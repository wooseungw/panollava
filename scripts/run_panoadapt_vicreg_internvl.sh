#!/bin/bash
# PanoAdapt VICReg Pairwise training + eval for InternVL3.5-2B on GPU 0
set -euo pipefail
...
echo "=========================================="
echo "  PanoAdapt VICReg Pairwise InternVL3.5-2B"
...
echo ""
echo "=========================================="
echo "  PanoAdapt VICReg Pairwise — ALL DONE"
echo "  Finished: $(date)"
echo "=========================================="
