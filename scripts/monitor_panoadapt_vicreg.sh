#!/bin/bash
# Monitor PanoAdapt VICReg training and auto-trigger evaluation on completion

PYTHON="/home/wsw/miniconda3/envs/pano/bin/python"
PANOADAPT_SESSION="panoadapt-vicreg"
TEST_CSV="/data/1_personal/4_SWWOO/panollava/runs/baseline/_shared_data/test.csv"

echo "🔍 Monitoring panoadapt-vicreg training..."
...
LATEST_CHECKPOINT=$(find runs/baseline/panoadapt_vicreg_pairwise_internvl35-2b -name "final" -type d | head -1)
...
$PYTHON -u scripts/baseline_eval.py \
    ...
    --test-csv "$TEST_CSV" \
    --output-dir "outputs/panoadapt_vicreg_pairwise_internvl35-2b_greedy" \
    2>&1 | tee "outputs/panoadapt_vicreg_pairwise_internvl35-2b_greedy/eval.log"

echo "✅ Evaluation complete!"
echo "Results saved to: outputs/panoadapt_vicreg_pairwise_internvl35-2b_greedy/metrics.json"
